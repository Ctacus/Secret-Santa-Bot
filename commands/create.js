...
module.exports = {
    ...
    async execute(message, args, prefix) {
        ...
        const embed = new Discord.MessageEmbed()
            .setTitle('__Грядёт Анонимный Дед Мороз 2021!__')
            .setDescription('Правила просты: вы становитесь Дедом Морозом для одного случайного участника, и кто-то один -- Дедом Морозом для вас!' +
